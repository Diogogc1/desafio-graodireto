...
export function CardItemPedido({ itemPedido }: { itemPedido: ItemPedidoOutput }) {
    return (
        <div className="border border-black mt-4 flex items-center sm:w-[55%] w-[80%] rounded-lg hover:bg-gray-50">
            <img src={itemPedido.itemCardapioOutput.fotoUrl} className="rounded-l-lg sm:w-[140px] w-[90px]" width={140} height={140} alt={`Foto do pedido do item ${itemPedido.itemCardapioOutput.nome}`} />
